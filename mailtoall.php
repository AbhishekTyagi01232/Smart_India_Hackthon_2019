<?php
//index.php
$connect = new PDO("mysql:host=localhost;dbname=project", "");
...
.container{
 ...
 <body >
  ...
  <br/>
  <div class="container">
   <h3 align="center">Send Email To All</h3>
   <br />
   <div class="table-responsive">
    ...
    <tr>
      <td colspan="3"></td>
      <td>
        <button type="submit" name="Send" class="btn btn-info email_button" id="bulk_email" data-action="bulk">Send Mail</button>
      </td>
    </td>
      </td>
    </table>
